...
const Eliminate = ({prevStep, SaveAndExit, nextStep, handleChange, values, moreValues}) => {
  const Continue = e => {
    e.preventDefault();
    nextStep();
  }
      ...
      <form className='Hazard-form'>
        <div className='Hazard-form-content'>
          ...
          <div style={{height: 200}} className='mt-3 overflow-auto'>
            <label className='form-label' htmlFor='eliminate'>Identify strategies to eliminate hazards from the job site</label>
